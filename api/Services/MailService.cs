...
namespace api.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendApproveCandidatelAsync(string fullName, string jobTitle, string emailCandidate)
        {
            string FilePath = Directory.GetCurrentDirectory() + "\\Templates\\ApprovedTemplate.html";
            StreamReader str = new StreamReader(FilePath);
            string MailText = str.ReadToEnd();
            str.Close();
            MailText = MailText.Replace("[fullname]", fullName).Replace("[jobTitle]", jobTitle);
        ...
        public async Task SendRejectCandidatelAsync(string fullName, string jobTitle, string emailCandidate)
        {
            string FilePath = Directory.GetCurrentDirectory() + "\\Templates\\RejectedTemplate.html";
            StreamReader str = new StreamReader(FilePath);
            string MailText = str.ReadToEnd();
            str.Close();
            MailText = MailText.Replace("[fullname]", fullName).Replace("[jobTitle]", jobTitle);
